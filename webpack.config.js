    ...
    rules: [
      {
        ...
        use: {
          ...
          options: {
            presets: [
              ['@babel/env', // This compiles es6, 7, 8, 9, 10 down to es5 - Supports latest javascript standard given in ecma script.
                {
                  useBuiltIns: 'entry',
                  corejs: 3, // default would be 2
                  targets: '> 0.25%, not dead',
                  // set your own target environment here (see Browsers list)
                },
              ],
            ],
            plugins: [
